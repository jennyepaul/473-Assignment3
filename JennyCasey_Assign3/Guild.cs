...
namespace JennyCasey_Assign3
{
     ...
     * Class - Guild
     * 
     * The guild class is used store the information of each individual guild. 
     * 
     * - There are 3 private attributes that stores information about each individual guild, such as the guild ID, name, type, and
     *    server
     * - The guild class has an IComparable interface in order to sort the guild based on its name.
     * - Guild Class Methods: 
